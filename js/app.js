 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".top-slider")) new core(".top-slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".trial-card-swiper")) new core(".trial-card-swiper", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".diet-card-swiper")) new core(".diet-card-swiper", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        da.init();
        const activeCompositionForm = document.querySelectorAll(".popup-diet__button");
        const activeButtonForm = document.querySelectorAll(".diet-form__button");
        const compositionWrapper = document.querySelectorAll(".popup-diet__composition-wrapper");
        const formWrapper = document.querySelectorAll(".popup-diet__form-wrapper");
        const acceptedWrapper = document.querySelectorAll(".popup-diet__accepted-wrapper");
        const closeFullWrapper = document.querySelectorAll(".popup__close-diet");
        for (let i = 0; i < activeCompositionForm.length; i++) activeCompositionForm[i].addEventListener("click", (function() {
            formWrapper[i].classList.add("popup-diet__active");
            compositionWrapper[i].classList.add("popup-diet__hide");
        }), false);
        for (let i = 0; i < closeFullWrapper.length; i++) closeFullWrapper[i].addEventListener("click", (function() {
            setTimeout((() => {
                formWrapper[i].classList.remove("popup-diet__active");
                compositionWrapper[i].classList.remove("popup-diet__hide");
                acceptedWrapper[i].classList.remove("popup-diet__active");
                formWrapper[i].classList.remove("popup-diet__hide");
            }), 800);
        }), false);
        for (let i = 0; i < activeButtonForm.length; i++) activeButtonForm[i].addEventListener("click", (function() {
            acceptedWrapper[i].classList.add("popup-diet__active");
            formWrapper[i].classList.remove("popup-diet__active");
            formWrapper[i].classList.add("popup-diet__hide");
        }), false);
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
